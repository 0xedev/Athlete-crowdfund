...
import {spicy} from "wagmi/chains"; // Import spicy chain for future use
...
const UserProfilePage = () => {
  ...
  const isWrongNetwork = chainId !== SPICY_CHAIN_ID;
  ...
  const handleSwitchNetwork = () => {
    try {
      switchChain({ chainId: SPICY_CHAIN_ID });
      toast.success("Switching to Spicy Network...");
    } catch (error) {

...
import { base, sepolia, spicy } from "wagmi/chains";
...
const ConnectWalletButton = () => {
  ...
  const allowedChainIds: number[] = [base.id, sepolia.id, spicy.id];
  const allowedChainNames = [base.name, sepolia.name, spicy.name].join(" or ");
